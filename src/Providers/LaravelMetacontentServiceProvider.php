...
namespace Faridlab\LaravelMetacontent\Providers;

use Illuminate\Support\ServiceProvider;

class LaravelMetacontentServiceProvider extends ServiceProvider
{
    /**
    ...
    public function boot()
    {
         ...
         */
        // $this->publishes([
        //     __DIR__.'/../../config/laravel-metacontent.php' => config_path('laravel-metacontent.php'),
        // ], 'config');
         ...
         */
        // $this->loadTranslationsFrom(__DIR__.'/../../resources/lang', 'laravel-metacontent');
        // $this->loadJsonTranslationsFrom(__DIR__.'/../../resources/lang', 'laravel-metacontent');
        // $this->publishes([
        //     __DIR__.'/../../resources/lang' => resource_path('lang/vendor/laravel-metacontent'),
        // ], 'translations');
         ...
         */
        // $this->loadViewsFrom(__DIR__.'/../../resources/views', 'laravel-metacontent');
        // $this->publishes([
        //     __DIR__.'/../../resources/views' => resource_path('views/vendor/laravel-metacontent'),
        // ], 'views');
        ...
        //     $this->commands([
        //         \Faridlab\LaravelMetacontent\Console\Commands\LaravelMetacontentCommand::class,
        //     ]);
        // }
         ...
         */
        // $this->publishes([
        //     __DIR__.'/../../public' => public_path('vendor/laravel-metacontent'),
        // ], 'public');
    ...
    public function register()
    {
        ...
        //     __DIR__.'/../../config/laravel-metacontent.php', 'laravel-metacontent'
        // );
    }
}
